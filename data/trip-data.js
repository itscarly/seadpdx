  ...
  itinerary: [
    {
      ...
      segments: [
        ...
        { label: "Evening", items: [
          ...
          { time: "8:25 PM", name: "Walk to Target Downtown Seattle", type: "walk", neighborhood: "Downtown", duration: "6 min", cost: 0, notes: "Short walk from Pike Place Chowder to Target for the Truly Hard Seltzer run." },
          { time: "8:31 PM", name: "Target Downtown Seattle - Truly Hard Seltzer run", type: "shopping", neighborhood: "Downtown Seattle", location: "Target, 1600 2nd Ave", duration: "20 min", cost: 22.10, website: "https://www.target.com/store-locator/store/seattle-downtown-1584/", payment: "Cards accepted", detailText: `Quick stop for the Truly Hard Seltzer fix to keep in the room for the rest of the Seattle stay.\nORDER: Truly Hard Seltzer 12-pack.\nEstimated cost: $20.00 + 10.5% WA sales tax = $22.10.` },
          { time: "8:51 PM", name: "Transit to H Mart International District", type: "transit", neighborhood: "Downtown -> International District", duration: "10 min", cost: 0, notes: "Link light rail, one stop. Already covered under the $6 ORCA day-pass claimed at the airport transfer earlier today -- $0 for this ride." },
          { time: "9:01 PM", name: "H Mart International District - grocery run", type: "shopping", neighborhood: "International District", location: "H Mart, 601 5th Ave S", duration: "25 min", cost: 19.89, website: "https://www.hmart.com/store/2270", payment: "Cards accepted", detailText: `Stock up on ready-to-heat food (rice bowls, dumplings, banchan, instant meals) for cheaper in-room meals over the Seattle stay -- the Palihotel has an in-room fridge/microwave-friendly setup for this.\nORDER: A mix of ready-to-heat meals, snacks, and drinks, budgeted around $18.\nEstimated cost: $18.00 + 10.5% WA sales tax = $19.89.` },
          { time: "9:26 PM", name: "Transit back to Palihotel", type: "transit", neighborhood: "International District -> Downtown", duration: "10 min", cost: 0, notes: "Link light rail back downtown, covered under today's day-pass -- $0." },
          { time: "9:36 PM", name: "Wind-down and early sleep", type: "rest", neighborhood: "Palihotel base", duration: "10+ hrs", cost: 0, notes: "Back to the hotel, settle in, early sleep to reset jet lag.", detailText: `Arrival-night wind-down.\nPurpose: Get good sleep after dinner and the Target/H Mart run. Day 2 is the full Pike Place day and you'll want fresh energy for it.\nContinuity: Sleep protection to stabilize next day.` }
        ]}
      ]
    },
    {
