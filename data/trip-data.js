    ...
    },
    {
      ...
      segments: [
        ...
        { label: "Afternoon", items: [
          ...
          { time: "1:15 PM", name: "Transit to Downtown / Uber office area", type: "transit", neighborhood: "Northgate -> Downtown", duration: "30 min", cost: 0, notes: "Link back south toward Pike Place area. Cost $0 -- covered by the day's $6 ORCA pass." },
          { time: "1:45 PM", name: "Uber Seattle Engineering Office - photo walk-by", type: "walk", neighborhood: "Downtown", location: "1191 2nd Ave, Suite 1200, Seattle, WA", duration: "15 min", cost: 0, notes: "Free photo/walk-by stop on the way from Downtown to Pike Place Market." },
          { time: "2:00 PM", name: "Original Starbucks store, 1912 Pike Place", type: "activity", neighborhood: "Pike Place", location: "Starbucks, 1912 Pike Place, Seattle, WA 98101", duration: "20 min", cost: 41, payment: "Cards accepted", detailText: `The first Starbucks store visit with three purchases:\n1. Whole bean coffee bag (1 lb): $16\n2. Seattle/Pike Place-exclusive ceramic mug: $20\n3. Grande cold brew: $5\nTotal: $41.\nEstimated cost: $41.\nPayment: Cards accepted.` },
          { time: "2:20 PM", name: "Pike Place Market wander", type: "activity", neighborhood: "Pike Place", location: "Pike Place Market", duration: "30 min", cost: 0, notes: "Browse swings, bronze Sasquatch statue, waterfront fountain, and the market atmosphere." },
          { time: "2:50 PM", name: "Old Stove Brewing", type: "activity", neighborhood: "MarketFront", location: "Old Stove Brewing, 1901 Western Ave Ste A", duration: "20 min", cost: 13, payment: "Cards accepted", detailText: `Brewpub with Elliott Bay views on the waterfront.\nOrder: One beer (menu price + tax + tip all-in).\nEstimated cost: $13 all-inclusive.\nPayment: Cards accepted.` },
          { time: "3:10 PM", name: "Overlook Walk (MarketFront viewing deck)", type: "walk", neighborhood: "Waterfront", location: "Overlook Walk, MarketFront", duration: "20 min", cost: 0, notes: "Free public space connecting Pike Place to the waterfront." },
          { time: "3:30 PM", name: "Harbor Steps", type: "walk", neighborhood: "Waterfront", location: "Harbor Steps Staircase Plaza", duration: "15 min", cost: 0, notes: "Free public staircase (107 steps) and plaza with fountains and benches." },
          { time: "3:45 PM", name: "Seattle Great Wheel - photo stop", type: "activity", neighborhood: "Waterfront", location: "Seattle Great Wheel, Pier 57", duration: "10 min", cost: 0, notes: "Photo-only stop (no entrance fee or ride)." },
          { time: "3:55 PM", name: "Transit to Columbia Center", type: "transit", neighborhood: "Waterfront -> Downtown", duration: "20 min", cost: 0, notes: "Link back south after the Pike Place/waterfront cluster. Cost $0 -- covered by the day's $6 ORCA pass." },
