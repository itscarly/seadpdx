  ...
  itinerary: [
    {
      ...
      segments: [
        ...
        { label: "Evening", items: [
          ...
          { time: "8:25 PM", name: "Walk to Target Downtown Seattle", type: "walk", neighborhood: "Downtown", duration: "4 min", cost: 0, notes: "Target (1401 2nd Ave) is a few doors from Palihotel (107 Pine St) -- no transit needed." },
          { time: "8:29 PM", name: "Target Downtown Seattle - Truly Hard Seltzer run", type: "shopping", neighborhood: "Downtown Seattle", location: "Target, 1401 2nd Ave", duration: "20 min", cost: 22.10, website: "https://www.target.com/store-locator/store/seattle-downtown-1584/", payment: "Cards accepted", detailText: `Quick stop for the Truly Hard Seltzer fix to keep in the room for the rest of the Seattle stay.\nORDER: Truly Hard Seltzer 12-pack.\nEstimated cost: $20.00 + 10.5% WA sales tax = $22.10.` },
          { time: "8:49 PM", name: "Walk to H Mart Downtown Seattle", type: "walk", neighborhood: "Downtown", duration: "3 min", cost: 0, notes: "H Mart (1601 2nd Ave) is two blocks up 2nd Ave from Target, still walkable, no transit needed." },
          { time: "8:52 PM", name: "H Mart Downtown Seattle - grocery run", type: "shopping", neighborhood: "Downtown Seattle", location: "H Mart, 1601 2nd Ave", duration: "25 min", cost: 19.89, website: "https://www.hmart.com/", payment: "Cards/Apple Pay only -- H Mart does not accept cash", detailText: `Stock up on ready-to-heat food (rice bowls, dumplings, banchan, instant meals) for cheaper in-room meals over the Seattle stay -- the Palihotel has an in-room fridge/microwave-friendly setup for this.\nORDER: A mix of ready-to-heat meals, snacks, and drinks, budgeted around $18.\nEstimated cost: $18.00 + 10.5% WA sales tax = $19.89.` },
          { time: "9:17 PM", name: "Walk back to Palihotel", type: "walk", neighborhood: "Downtown", duration: "6 min", cost: 0, notes: "Short walk back down 2nd Ave / Pine St to Palihotel." },
          { time: "9:23 PM", name: "Wind-down and early sleep", type: "rest", neighborhood: "Palihotel base", duration: "10+ hrs", cost: 0, notes: "Back to the hotel, settle in, early sleep to reset jet lag.", detailText: `Arrival-night wind-down.\nPurpose: Get good sleep after dinner and the Target/H Mart run. Day 2 is the full Pike Place day and you'll want fresh energy for it.\nContinuity: Sleep protection to stabilize next day.` }
        ]}
      ]
    },
    {
