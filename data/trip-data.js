    ...
    },
    {
      ...
      segments: [
        { label: "Morning", items: [
          ...
          { time: "8:15 AM", name: "Transit to Pike Place", type: "transit", neighborhood: "Capitol Hill -> Downtown", duration: "20 min", cost: 6, notes: "Link or bus into the market core. First ORCA ride of Day 2 -- flat $6 day-pass charge." },
          { time: "8:35 AM", name: "Pike Place sign + arcade stroll", type: "activity", neighborhood: "Downtown", location: "Pike Place Market", duration: "20 min", cost: 0, payment: "Free walk-in", detailText: `Start at the sign and the arcade so the market feels like a sequence, not one blob.\nOrder: Walk the sign, the main arcade, and the first fish-market row.\nLine time: None unless the entrance is unusually busy.\nEstimated cost: Free.` },
          ...
          { time: "9:25 AM", name: "Piroshky Piroshky snack", type: "coffee", neighborhood: "Downtown", location: "Piroshky Piroshky, Pike Place Market", duration: "15 min", cost: 9, payment: "Cards accepted", detailText: `Quick Pike Place snack -- now doing double duty as part of breakfast since Glo's Diner was removed.\nOrder: Classic piroshky or savory cheese-filled option.\nLine time: About 5-10 min at a normal weekday pace.\nEstimated cost: $8-9 with tax.` },
          { time: "9:40 AM", name: "Original Starbucks store, 1912 Pike Place", type: "activity", neighborhood: "Pike Place", location: "Starbucks, 1912 Pike Place, Seattle, WA 98101", duration: "20 min", cost: 41, payment: "Cards accepted", detailText: `The first Starbucks store visit with three purchases:\n1. Whole bean coffee bag (1 lb): $16\n2. Seattle/Pike Place-exclusive ceramic mug: $20\n3. Grande cold brew: $5\nTotal: $41.\nEstimated cost: $41.\nPayment: Cards accepted.` },
          { time: "10:00 AM", name: "Hellenika Cultured Creamery", type: "coffee", neighborhood: "Pike Place", location: "Hellenika Cultured Creamery, Pike Place Market", duration: "15 min", cost: 13, payment: "Cards accepted", detailText: `Greek yogurt/creamery stop, traveler-pegged price from the Google Maps route.\nOrder: A cup or cone of Greek yogurt/gelato.\nEstimated cost: $13.\nPayment: Cards accepted.` },
          { time: "10:15 AM", name: "Beecher's Handmade Cheese tasting", type: "activity", neighborhood: "Downtown", location: "Beecher's Handmade Cheese, Pike Place Market", duration: "15 min", cost: 9, payment: "Cards accepted", detailText: `Cheese stop for a short tastings-and-snack visit.\nOrder: Small sample, grilled cheese, or mac if you want a fuller bite.\nLine time: Expect roughly 5-15 min.\nEstimated cost: $9.` },
          { time: "10:30 AM", name: "Rachel's Ginger Beer -- Frozen Mango Margarita", type: "activity", neighborhood: "Downtown", location: "Rachel's Ginger Beer, Pike Place Market", duration: "15 min", cost: 18, website: "https://rachelsgingerbeer.com/pages/menu", payment: "Cards accepted", detailText: `Frozen cocktail stop.\nMenu: https://rachelsgingerbeer.com/pages/menu\nORDER: Frozen Mango Margarita -- ginger, mango, triple sec, tequila.\nLine time: Usually about 5-10 min.\nEstimated cost: $18.` },
          ...
          { time: "11:00 AM", name: "Daily Dozen Doughnuts + Mocha", type: "coffee", neighborhood: "Downtown", location: "Daily Dozen Doughnut Company, Pike Place Market", duration: "10 min", cost: 16, payment: "Cash preferred", detailText: `Tiny doughnut stop built for a quick bite.\nORDER: Daily Dozen assorted mini doughnuts, plus a 12oz Mocha Hot Coffee.\nLine time: Usually quick, about 5-10 min.\nEstimated cost: $16.` },
          { time: "11:10 AM", name: "Ghost Alley Espresso", type: "coffee", neighborhood: "Pike Place / Post Alley", location: "Ghost Alley Espresso, 1499 Post Alley", duration: "20 min", cost: 8.50, website: "https://www.ghostalleyespresso.co/menus", payment: "Cards accepted", detailText: `Quick specialty latte stop closing out the market food crawl before heading to the waterfront.\nMenu: https://www.ghostalleyespresso.co/menus\nOrder: Salted Nut 12oz or one of the sweeter seasonal specials if you want the fast comfort pick.\nEstimated cost: $8.50.\nPayment: Cards accepted.` }
        ]},
        { label: "Afternoon", items: [
          { time: "11:30 AM", name: "Seattle Waterfront photo loop", type: "activity", neighborhood: "Waterfront", location: "Seattle Waterfront", duration: "25 min", cost: 0, payment: "Free walk-in", detailText: `Short photo block for the Seattle look.\nPhoto targets: The Ferris wheel from the waterfront and a wide skyline frame.\nWhat to shoot: A wide skyline shot and one close-up with the wheel.\nLine time: None.\nEstimated cost: Free.` },
          { time: "11:55 AM", name: "Overlook Walk (MarketFront viewing deck)", type: "walk", neighborhood: "Waterfront", location: "Overlook Walk, MarketFront", duration: "20 min", cost: 0, notes: "Free public space connecting Pike Place to the waterfront." },
          { time: "12:15 PM", name: "Old Stove Brewing", type: "activity", neighborhood: "MarketFront", location: "Old Stove Brewing, 1901 Western Ave Ste A", duration: "20 min", cost: 13, payment: "Cards accepted", detailText: `Brewpub with Elliott Bay views on the waterfront.\nOrder: One beer (menu price + tax + tip all-in).\nEstimated cost: $13 all-inclusive.\nPayment: Cards accepted.` },
          { time: "12:35 PM", name: "Walk to Olympic Sculpture Park", type: "walk", neighborhood: "Waterfront", duration: "25 min", cost: 0, notes: "Longer waterfront leg south to north along the shoreline." },
          { time: "1:00 PM", name: "Olympic Sculpture Park browse", type: "activity", neighborhood: "Waterfront", location: "Olympic Sculpture Park", duration: "20 min", cost: 0, payment: "Free walk-in", notes: "Free outdoor sculpture park, part of the waterfront loop back toward the Great Wheel." },
          { time: "1:20 PM", name: "Seattle Great Wheel - photo stop", type: "activity", neighborhood: "Waterfront", location: "Seattle Great Wheel, Pier 57", duration: "10 min", cost: 0, notes: "Photo-only stop (no entrance fee or ride)." },
          { time: "1:30 PM", name: "Harbor Steps", type: "walk", neighborhood: "Waterfront", location: "Harbor Steps Staircase Plaza", duration: "15 min", cost: 0, notes: "Free public staircase (107 steps) and plaza with fountains and benches." },
          { time: "1:45 PM", name: "Pike Place Market swings", type: "activity", neighborhood: "Pike Place", location: "Pike Place Market", duration: "15 min", cost: 0, notes: "Browse swings and the bronze Sasquatch statue -- last stop of the Pike Place/waterfront loop before the Uber office." },
          { time: "2:00 PM", name: "Uber Seattle Engineering Office visit", type: "walk", neighborhood: "Downtown", location: "1191 2nd Ave, Suite 1200, Seattle, WA", duration: "40 min", cost: 0, notes: "Short walk from the swings, then 30-45 min to look around and take photos outside the office before Best Buy." },
          { time: "2:40 PM", name: "Transit to Best Buy Northgate", type: "transit", neighborhood: "Downtown -> Northgate", duration: "35 min", cost: 0, notes: "Link north to Northgate. Cost $0 -- covered by the day's $6 ORCA pass." },
          { time: "3:15 PM", name: "Best Buy Northgate - Ray-Ban Meta glasses fit check", type: "activity", neighborhood: "Northgate", location: "Best Buy Northgate, 330 NE Northgate Way", duration: "40 min", cost: 0, payment: "No purchase required; cards accepted if you buy accessories", detailText: `Link light rail to Northgate Station and walk to Best Buy.\nPurpose: Try on Ray-Ban Meta glasses for frame fit only. No demo needed -- just confirm fit.\nOrder tip: Once fit is confirmed, order through Amazon for delivery to Courtyard Portland.\nContinuity: Courtyard Portland address for delivery is 550 SW Oak St, Portland, OR 97204. Call +1-503-233-3343 to confirm they hold packages.\nBest Buy hours: Monday 10 AM to 9 PM.\nEstimated cost: Fit check only, no required spend during this stop.` },
          { time: "3:55 PM", name: "Transit to Columbia Center", type: "transit", neighborhood: "Northgate -> Downtown", duration: "38 min", cost: 0, notes: "Link back south to Columbia Center. Cost $0 -- covered by the day's $6 ORCA pass." },
          { time: "4:35 PM", name: "Columbia Center Sky View Observatory - Elite Experience ticket", type: "activity", neighborhood: "Downtown", location: "Sky View Observatory, 700 4th Ave", duration: "60 min", cost: 52.50, website: "https://skyviewobservatory.com/tickets/", payment: "Cards accepted", detailText: `Seattle skyline views from the observation deck, timed to catch the sunset.\nSunset timing: Seattle sunset on Nov 2, 2026 (Pacific Standard Time, after DST ends Nov 1) is approximately 4:53 PM -- sunset lands mid-visit.\nTickets: https://skyviewobservatory.com/tickets/ — Elite Experience Adult: $49 + booking fee $1 + WA tax $2.50 = $52.50.\nEstimated cost: $52.50.\nPayment: Cards accepted.` },
          { time: "5:35 PM", name: "Sky View Cafe - sunset cocktail + sandwich", type: "activity", neighborhood: "Downtown", location: "Sky View Observatory Cafe, 700 4th Ave", duration: "30 min", cost: 41.12, website: "https://skyviewobservatory.com/sky-view-cafe-bar-menu/", payment: "Cards accepted", detailText: `Food and cocktail at the Sky View Cafe while watching dusk skyline lights after sunset.\nCafe menu: https://skyviewobservatory.com/sky-view-cafe-bar-menu/\nORDER: One cocktail (~$18) + BLT sandwich ($14) + ~10.5% WA sales tax + 18% tip = ~$41.12 all-in.\nEstimated cost: $41.12.\nPayment: Cards accepted.` }
        ]},
        { label: "Evening", items: [
          { time: "6:05 PM", name: "Transit back to Capitol Hill", type: "transit", neighborhood: "Downtown -> Capitol Hill", duration: "20 min", cost: 0, notes: "Bus or Link ride back to the hotel after Sky View sunset/dusk. Cost $0 -- covered by the day's $6 ORCA pass." },
          { time: "6:25 PM", name: "Free evening + wind-down", type: "rest", neighborhood: "Boylston base", duration: "14 hrs", cost: 0, notes: "Day ends after the full Pike Place/waterfront loop, Best Buy, the Uber office visit, and the sunset Sky View experience -- no dinner stop needed." }
        ]}
      ]
    },
    {
