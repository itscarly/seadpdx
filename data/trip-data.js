  ...
  itinerary: [
    {
      ...
      date: "Sun, Nov 1",
      city: "Seattle",
      title: "Arrival and downtown Pike Place reset day",
      theme: "Recovery + walkable downtown exploration",
      dayTotal: 6,
      weatherPlan: "Keep arrival day calm and simple — focus on resting and light downtown orientation only.",
      segments: [
        { label: "Afternoon", items: [
          { time: "1:55 PM", leaveTime: "2:20 PM", name: "Arrive SEA and transfer to Link", type: "transit", neighborhood: "SEA Airport", duration: "25 min", cost: 6, notes: "Bag claim, station walk, ORCA tap setup. First ORCA ride of Day 1 -- flat $6 day-pass charge.", detailText: `Arrival transition block after landing in Seattle.\nPurpose: Clear baggage claim, get oriented inside SEA, and set up the first ORCA tap before heading into the city.\nEstimated cost: $6 for the airport-to-city transit leg (ORCA day-pass model, first ride of the day).\nTiming: Keep this efficient so the downtown Palihotel arrival still feels calm instead of rushed.`, route: "https://www.google.com/maps/dir/SEA+Airport/Downtown+Seattle" },
          { time: "2:20 PM", name: "Link light rail to Downtown Seattle", type: "transit", neighborhood: "SEA -> Downtown", duration: "45 min", cost: 0, notes: "Ride to downtown tunnel stations near Pike Place; fare already counted above.", detailText: `Link ride from SEA into Downtown Seattle.\nWhat to expect: This is the easy no-drama airport transfer, so just settle in, hydrate, and let the arrival day stay simple.\nCost note: Fare already counted in the previous airport-transfer stop.`, route: "https://www.google.com/maps/dir/SEA+Airport/Downtown+Seattle" },
          { time: "3:05 PM", name: "Walk to Palihotel and luggage reset", type: "walk", neighborhood: "Downtown", duration: "15 min", cost: 0, notes: "Short walk from downtown station to 107 Pine St, quick unpack, hydrate, rest.", detailText: `Short station-to-hotel walk.\nWhat to expect: Palihotel is right in the heart of downtown near Pike Place, so this walk is very manageable even jet-lagged.\nContinuity: This is just enough reset time to keep the evening calm instead of zombie-mode.` },
          { time: "3:20 PM", name: "Palihotel check-in and shower reset", type: "rest", neighborhood: "Palihotel base", duration: "60 min", cost: 0, notes: "Check in (early arrival possible), shower, recharge, switch to comfortable clothes.", detailText: `Check-in and jet-lag buffer.\nWhat to expect: Shower, recharge, and rest without rushing. This block is protected time.\nPurpose: Arrival night works best when recovery stays a priority.` },
          { time: "4:20 PM", name: "Light downtown walk and early dinner", type: "walk", neighborhood: "Downtown / Pike Place area", duration: "180 min", cost: 0, notes: "Casual evening: explore Palihotel area, Pike Place vicinity, maybe grab a light bite nearby. No structured agenda -- just wander and get your bearings.", detailText: `Relaxed downtown orientation on your first evening.\nVibe: Keep it loose. Spot cafes, see the evening neighborhood, get comfortable.\nFood: Grab something casual/light nearby (coffee, snack, or light dinner) rather than a structured sit-down; you can decide what you want when you see what's around.\nCost: Included in your daily discretionary food spend.\nPurpose: Meet the downtown vibe and rest before Day 2's full itinerary.` }
        ]},
        { label: "Evening", items: [
          { time: "7:40 PM", name: "Dinner and wind-down at Palihotel area", type: "rest", neighborhood: "Palihotel base", duration: "11+ hrs", cost: 0, notes: "Settle in for the evening. Keep it low-key — dinner nearby or at hotel, early sleep to reset jet lag.", detailText: `Arrival-night wind-down.\nPurpose: Eat something light if you're hungry, then get good sleep. Day 2 is the full Pike Place day and you'll want fresh energy for it.\nContinuity: Sleep protection to stabilize next day.` }
        ]}
      ]
    },
    {
      ...
      date: "Mon, Nov 2",
      city: "Seattle",
      title: "Pike Place Market and waterfront - fully walkable from Palihotel",
      theme: "Classic Seattle morning + relaxed afternoon + sunset",
      dayTotal: 168.12,
      ...
      segments: [
        { label: "Morning", items: [
          ...
          { time: "9:25 AM", name: "Original Starbucks store, 1912 Pike Place", type: "activity", neighborhood: "Pike Place", location: "Starbucks, 1912 Pike Place, Seattle, WA 98101", duration: "30 min", cost: 41, payment: "Cards accepted", detailText: `First Starbucks visit: whole bean coffee bag ($16) + Seattle mug ($20) + grande cold brew ($5) = $41.\nEstimated cost: $41.` },
          { time: "9:55 AM", name: "Ghost Alley Espresso", type: "coffee", neighborhood: "Pike Place / Post Alley", location: "Ghost Alley Espresso, 1499 Post Alley", duration: "20 min", cost: 8.50, website: "https://www.ghostalleyespresso.co/menus", payment: "Cards accepted", detailText: `Quality specialty latte before the waterfront walk.\nMenu: https://www.ghostalleyespresso.co/menus\nOrder: Salted Nut 12oz.\nEstimated cost: $8.50.` },
          { time: "10:15 AM", name: "Light Pike Place browse + casual snack", type: "walk", neighborhood: "Pike Place", duration: "45 min", cost: 0, notes: "Browse the market stalls, spot lunch spots for later, enjoy the morning vibe. No structured stops -- just wander." }
        ]},
        { label: "Afternoon", items: [
          { time: "11:00 AM", name: "Walk to Seattle Waterfront", type: "walk", neighborhood: "Downtown -> Waterfront", duration: "20 min", cost: 0, notes: "Leisurely walk down to the waterfront." },
          { time: "11:20 AM", name: "Waterfront walk + photo time", type: "walk", neighborhood: "Waterfront", location: "Seattle Waterfront & Olympic Sculpture Park", duration: "90 min", cost: 0, payment: "Free walk-in", detailText: `Relaxed waterfront afternoon. Walk along the shore, Olympic Sculpture Park, Great Wheel photos, Harbor Steps -- no rush.\nWhat to do: Walk at your own pace, take photos, sit and people-watch if you want.\nEstimated cost: Free.` },
          { time: "12:50 PM", name: "Lunch stop (self-choose)", type: "meal", neighborhood: "Waterfront or Pike Place area", duration: "60 min", cost: 26.12, payment: "Cards accepted", detailText: `Find a casual lunch spot along the waterfront or Pike Place area. Keep it relaxed -- no structured reservation needed.\nEstimated cost: $26.12 (lunch with tax and tip, you pick the spot).` },
          { time: "1:50 PM", name: "Afternoon rest/explore", type: "rest", neighborhood: "Palihotel area or Downtown", duration: "120 min", cost: 0, notes: "Head back toward the hotel, rest, freshen up, or wander downtown. Open time to meet people, relax in a cafe, or just enjoy the neighborhood." },
          { time: "3:50 PM", name: "Columbia Center Sky View Observatory - Elite Experience ticket", type: "activity", neighborhood: "Downtown", location: "Sky View Observatory, 700 4th Ave", duration: "60 min", cost: 52.50, website: "https://skyviewobservatory.com/tickets/", payment: "Cards accepted", detailText: `Seattle skyline views from the observation deck, timed to catch the sunset.\nSunset: Nov 2, 2026, approximately 4:53 PM.\nTickets: Elite Experience Adult $49 + booking fee $1 + tax $2.50 = $52.50.` },
          { time: "4:50 PM", name: "Sky View Cafe - sunset cocktail", type: "activity", neighborhood: "Downtown", location: "Sky View Observatory Cafe, 700 4th Ave", duration: "30 min", cost: 0, website: "https://skyviewobservatory.com/sky-view-cafe-bar-menu/", payment: "Cards accepted", notes: "Included in the Sky View admission. Enjoy the dusk lights from the deck." }
        ]},
        { label: "Evening", items: [
          { time: "5:20 PM", name: "Walk back to Palihotel + free evening", type: "walk", neighborhood: "Downtown -> Palihotel", duration: "15 min", cost: 0, notes: "Short walk back to the hotel. Evening is open -- find dinner nearby, meet people, relax." },
          { time: "5:40 PM", name: "Dinner and wind-down (self-choose)", type: "rest", neighborhood: "Palihotel area or Downtown", duration: "10+ hrs", cost: 0, notes: "Open evening. Grab dinner somewhere casual nearby, settle in, early sleep or continue exploring if you feel like it." }
        ]}
      ]
    },
    {
      ...
      segments: [
        ...
        { label: "Evening", items: [
          { time: "2:10 PM", name: "Walk/transit back to Palihotel", type: "transit", neighborhood: "Ferry Terminal -> Downtown", duration: "20 min", cost: 0, notes: "Short return to downtown hotel. Menya Musashi ramen (Capitol Hill) removed to avoid unnecessary Capitol Hill transit." },
          { time: "2:40 PM", name: "Extended hotel recharge + rest", type: "rest", neighborhood: "Palihotel base", duration: "18.5 hrs", cost: 0, notes: "Longer afternoon/evening rest. No dinner stop needed. Full recovery before the last Seattle full-activity day." }
        ]}
      ]
    },
    {
      ...
      segments: [
        { label: "Morning", items: [
          ...
          { time: "8:10 AM", name: "Transit to Fremont", type: "transit", neighborhood: "Downtown -> Fremont", duration: "45 min", cost: 6, notes: "Direct Link transit from downtown Palihotel. First ORCA ride of Day 4 -- flat $6 day-pass charge." },
          { time: "8:55 AM", name: "Fremont walking loop", type: "walk", neighborhood: "Fremont", duration: "110 min", cost: 0 }
        ]},
        { label: "Afternoon", items: [
          { time: "10:45 AM", name: "Uneeda Burger Fremont lunch", type: "meal", neighborhood: "Fremont", location: "Uneeda Burger", duration: "85 min", cost: 18, website: "https://uneedaburger.com/seattle-fremont-uneeda-burger-food-menu", payment: "Cards accepted", detailText: `Counter-service Fremont burger institution.\nMenu: https://uneedaburger.com/seattle-fremont-uneeda-burger-food-menu\nORDER: Uneeda Burger Chipotle Chicken Burger.\nFruity: Strawberry or seasonal milkshake is the fruit-leaning move here.\nEstimated cost: $18 with tip.` },
          { time: "12:10 PM", name: "Transit to Ballard", type: "transit", neighborhood: "Fremont -> Ballard", duration: "25 min", cost: 0 },
          { time: "12:35 PM", name: "Ballard Ave + locks area explore", type: "walk", neighborhood: "Ballard", duration: "110 min", cost: 0 },
          { time: "2:25 PM", name: "Ballard Coffee Works reset", type: "coffee", neighborhood: "Ballard", location: "Ballard Coffee Works, 2060 NW Market St", duration: "45 min", cost: 6, website: "https://www.ballardcoffee-co.com/menus", payment: "Cards accepted", detailText: `Ballard Coffee Works for the afternoon reset before heading back downtown.\nMenu: https://www.ballardcoffee-co.com/menus\nORDER: Cold Brew (16oz).\nSKIP: Heavy snack unless your feet are dragging.\nEstimated cost: $6.` }
        ]},
        { label: "Evening", items: [
          { time: "3:10 PM", name: "Transit back to Palihotel", type: "transit", neighborhood: "Ballard -> Downtown", duration: "45 min", cost: 0 },
          { time: "3:55 PM", name: "Return and pack for train day", type: "rest", neighborhood: "Palihotel base", duration: "8+ hrs", cost: 0, notes: "Dinner removed from plan -- open evening slot, wind-down and rest block so the train departure stays protected. Last night in Seattle." }
        ]}
      ]
    },
    {
      ...
      segments: [
        { label: "Morning", items: [
          { time: "7:00 AM", name: "Wake, final pack, checkout prep", type: "rest", neighborhood: "Palihotel base", duration: "120 min", cost: 0, notes: "Light prep and packing. King Street Station is walking distance from downtown Palihotel." },
