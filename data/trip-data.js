  ...
  itinerary: [
    {
      ...
      segments: [
        ...
        { label: "Evening", items: [
          { time: "7:40 PM", name: "Pike Place Chowder - light dinner", type: "meal", neighborhood: "Palihotel base / Pike Place", location: "Pike Place Chowder, 1530 Post Alley", duration: "45 min", cost: 22, website: "https://pikeplacechowder.com/", payment: "Cards accepted", notes: "Casual counter-service spot 4 min walk from Palihotel. Cup of chowder + roll + drink -- light and quick after a long travel day, no reservation needed.", detailText: `Light, casual arrival-night dinner.\nWhy this spot: 4-minute walk from Palihotel, counter service (no wait for a table), award-winning clam chowder -- easy on a jet-lagged stomach and doesn't require decision-making energy.\nOrder: Cup of clam chowder + sourdough roll + drink.\nEstimated cost: $22 (food + WA sales tax + tip).\nPurpose: Eat something warm and simple, then head back to Palihotel for early sleep to reset jet lag. Day 2 is the full Pike Place day and you'll want fresh energy for it.` },
          { time: "8:25 PM", name: "Wind-down and early sleep", type: "rest", neighborhood: "Palihotel base", duration: "10+ hrs", cost: 0, notes: "Back to the hotel, settle in, early sleep to reset jet lag.", detailText: `Arrival-night wind-down.\nPurpose: Get good sleep after dinner. Day 2 is the full Pike Place day and you'll want fresh energy for it.\nContinuity: Sleep protection to stabilize next day.` }
        ]}
      ]
    },
    {
      ...
      segments: [
        { label: "Morning", items: [
          ...
          { time: "10:55 AM", name: "Mee Sum Pastry", type: "meal", neighborhood: "Pike Place", location: "Mee Sum Pastry, 1526 Pike Pl", duration: "15 min", cost: 9, website: "https://www.meesumpastry.com/menu", payment: "Cards accepted", detailText: `Menu: https://www.meesumpastry.com/menu\nORDER: Hawaiian-style Pork Hum Bao (the classic here since 1935) -- ask for it warm.\nEstimated cost: $9.` },
          { time: "11:10 AM", name: "Daily Dozen Doughnuts + Mocha", type: "meal", neighborhood: "Pike Place", location: "Daily Dozen Doughnuts, Pike Place Market", duration: "15 min", cost: 16, website: "https://dailydozendoughnuts.com/", payment: "Cards accepted", detailText: `Menu: https://dailydozendoughnuts.com/\nORDER: Dozen mini cinnamon-sugar doughnuts fresh from the fryer, plus a mocha to go with it.\nEstimated cost: $16.` },
          { time: "11:25 AM", name: "Ghost Alley Espresso", type: "coffee", neighborhood: "Pike Place / Post Alley", location: "Ghost Alley Espresso, 1499 Post Alley", duration: "20 min", cost: 8.50, website: "https://www.ghostalleyespresso.co/menus", payment: "Cards accepted", detailText: `Quality specialty latte before the waterfront walk.\nMenu: https://www.ghostalleyespresso.co/menus\nOrder: Salted Nut 12oz.\nEstimated cost: $8.50.` },
    ...
    },
    {
      ...
      segments: [
        ...
        { label: "Evening", items: [
          ...
          { time: "8:05 PM", name: "Menya Musashi ramen dinner", type: "meal", neighborhood: "Capitol Hill", duration: "60 min", cost: 27, website: "https://menyamuso.us/ramen-menu-seattle/", payment: "Cards accepted", detailText: `Menu: https://menyamuso.us/ramen-menu-seattle/\nORDER: Musashi Tonkotsu ramen (the house signature) with a side of gyoza to split.\nEstimated cost: $27.` },
    ...
    },
    {
      ...
      segments: [
        { label: "Morning", items: [
          { time: "7:00 AM", name: "Wake + prep", type: "rest", neighborhood: "Palihotel base", duration: "40 min", cost: 0 },
          { time: "7:40 AM", name: "Target Downtown Seattle - breakfast + Truly Hard Seltzer run", type: "shopping", neighborhood: "Downtown Seattle", location: "Target, 1600 2nd Ave", duration: "35 min", cost: 35.36, website: "https://www.target.com/store-locator/store/seattle-downtown-1584/", payment: "Cards accepted", notes: "Cheaper grab-and-go alternative to The Hart and the Hunter's brunch menu at Palihotel; also restocks the Truly Hard Seltzer fix for the trip.", detailText: `Grab-and-go breakfast items plus a Truly Hard Seltzer 12-pack -- both cheaper here than at the hotel restaurant.\nAlternative: The Hart and the Hunter (Palihotel's own restaurant) brunch is also an option if you'd rather sit down -- H&H Breakfast $17, Eggs Benedict $21, Waffle $15, or Biscuits & Gravy $16, plus a $17 brunch cocktail (Mimosa, Bloody Mary, Espresso Martini) if you want to make it boozy.\nORDER (Target run): quick pastry/fruit/protein breakfast items (~$12) + Truly Hard Seltzer 12-pack ($20).\nEstimated cost: $32.00 subtotal + 10.5% WA sales tax ($3.36) = $35.36.` },
          { time: "8:15 AM", name: "Finish packing", type: "rest", neighborhood: "Palihotel base", duration: "45 min", cost: 0 },
