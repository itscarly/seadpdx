    ...
    },
    {
      ...
      segments: [
        ...
        { label: "Afternoon", items: [
          ...
          { time: "12:15 PM", name: "Ghost Alley Espresso", type: "coffee", neighborhood: "Pike Place / Post Alley", location: "Ghost Alley Espresso, 1499 Post Alley", duration: "20 min", cost: 8.50, website: "https://www.ghostalleyespresso.co/menus", payment: "Cards accepted", detailText: `Quick specialty latte stop on the way into the Pike Place cluster.\nMenu: https://www.ghostalleyespresso.co/menus\nOrder: Salted Nut 12oz or one of the sweeter seasonal specials if you want the fast comfort pick.\nEstimated cost: $8.50.\nPayment: Cards accepted.` },
          { time: "12:35 PM", name: "Original Starbucks store, 1912 Pike Place", type: "activity", neighborhood: "Pike Place", location: "Starbucks, 1912 Pike Place, Seattle, WA 98101", duration: "20 min", cost: 41, payment: "Cards accepted", detailText: `The first Starbucks store visit with three purchases:\n1. Whole bean coffee bag (1 lb): $16\n2. Seattle/Pike Place-exclusive ceramic mug: $20\n3. Grande cold brew: $5\nTotal: $41.\nEstimated cost: $41.\nPayment: Cards accepted.` },
          { time: "12:55 PM", name: "Pike Place Market wander", type: "activity", neighborhood: "Pike Place", location: "Pike Place Market", duration: "30 min", cost: 0, notes: "Browse swings, bronze Sasquatch statue, waterfront fountain, and the market atmosphere." },
          { time: "1:25 PM", name: "Old Stove Brewing", type: "activity", neighborhood: "MarketFront", location: "Old Stove Brewing, 1901 Western Ave Ste A", duration: "20 min", cost: 13, payment: "Cards accepted", detailText: `Brewpub with Elliott Bay views on the waterfront.\nOrder: One beer (menu price + tax + tip all-in).\nEstimated cost: $13 all-inclusive.\nPayment: Cards accepted.` },
          { time: "1:45 PM", name: "Overlook Walk (MarketFront viewing deck)", type: "walk", neighborhood: "Waterfront", location: "Overlook Walk, MarketFront", duration: "20 min", cost: 0, notes: "Free public space connecting Pike Place to the waterfront." },
          { time: "2:05 PM", name: "Harbor Steps", type: "walk", neighborhood: "Waterfront", location: "Harbor Steps Staircase Plaza", duration: "15 min", cost: 0, notes: "Free public staircase (107 steps) and plaza with fountains and benches." },
          { time: "2:20 PM", name: "Seattle Great Wheel - photo stop", type: "activity", neighborhood: "Waterfront", location: "Seattle Great Wheel, Pier 57", duration: "10 min", cost: 0, notes: "Photo-only stop (no entrance fee or ride). Last Pike Place/waterfront cluster stop before heading north to Best Buy Northgate." },
          { time: "2:30 PM", name: "Best Buy Northgate - Ray-Ban Meta glasses fit check", type: "activity", neighborhood: "Northgate", location: "Best Buy Northgate, 330 NE Northgate Way", duration: "40 min", cost: 0, payment: "No purchase required; cards accepted if you buy accessories", detailText: `Link light rail to Northgate Station and walk to Best Buy.\nPurpose: Try on Ray-Ban Meta glasses for frame fit only. No demo needed -- just confirm fit.\nOrder tip: Once fit is confirmed, order through Amazon for delivery to Courtyard Portland.\nContinuity: Courtyard Portland address for delivery is 550 SW Oak St, Portland, OR 97204. Call +1-503-233-3343 to confirm they hold packages.\nBest Buy hours: Monday 10 AM to 9 PM.\nEstimated cost: Fit check only, no required spend during this stop.` },
          { time: "3:10 PM", name: "Transit to Downtown / Uber office area", type: "transit", neighborhood: "Northgate -> Downtown", duration: "30 min", cost: 0, notes: "Link back south toward the Uber office and Columbia Center. Cost $0 -- covered by the day's $6 ORCA pass." },
          { time: "3:40 PM", name: "Uber Seattle Engineering Office visit", type: "walk", neighborhood: "Downtown", location: "1191 2nd Ave, Suite 1200, Seattle, WA", duration: "40 min", cost: 0, notes: "Flexible stop after Best Buy, before Columbia Center -- 30-45 min to look around and take photos outside the office." },
          { time: "4:20 PM", name: "Walk to Columbia Center", type: "walk", neighborhood: "Downtown", duration: "10 min", cost: 0, notes: "Short walk -- the Uber office and Columbia Center are both in the downtown core, a few blocks apart." },
          { time: "4:30 PM", name: "Columbia Center Sky View Observatory - Elite Experience ticket", type: "activity", neighborhood: "Downtown", location: "Sky View Observatory, 700 4th Ave", duration: "60 min", cost: 52.50, website: "https://skyviewobservatory.com/tickets/", payment: "Cards accepted", detailText: `Seattle skyline views from the observation deck, timed to catch the sunset.\nSunset timing: Seattle sunset on Nov 2, 2026 (Pacific Standard Time, after DST ends Nov 1) is approximately 4:53 PM -- sunset lands mid-visit.\nTickets: https://skyviewobservatory.com/tickets/ — Elite Experience Adult: $49 + booking fee $1 + WA tax $2.50 = $52.50.\nEstimated cost: $52.50.\nPayment: Cards accepted.` },
          { time: "5:30 PM", name: "Sky View Cafe - sunset cocktail + sandwich", type: "activity", neighborhood: "Downtown", location: "Sky View Observatory Cafe, 700 4th Ave", duration: "30 min", cost: 41.12, website: "https://skyviewobservatory.com/sky-view-cafe-bar-menu/", payment: "Cards accepted", detailText: `Food and cocktail at the Sky View Cafe while watching dusk skyline lights after sunset.\nCafe menu: https://skyviewobservatory.com/sky-view-cafe-bar-menu/\nORDER: One cocktail (~$18) + BLT sandwich ($14) + ~10.5% WA sales tax + 18% tip = ~$41.12 all-in.\nEstimated cost: $41.12.\nPayment: Cards accepted.` }
        ]},
        { label: "Evening", items: [
          { time: "6:00 PM", name: "Transit back to Capitol Hill", type: "transit", neighborhood: "Downtown -> Capitol Hill", duration: "45 min", cost: 0, notes: "Bus or Link ride back to the hotel after Sky View sunset/dusk. Cost $0 -- covered by the day's $6 ORCA pass." },
          { time: "6:50 PM", name: "Free evening + wind-down", type: "rest", neighborhood: "Boylston base", duration: "14 hrs", cost: 0, notes: "Day ends after a full Pike Place/waterfront cluster, Best Buy, the Uber office visit, and the sunset Sky View experience -- no dinner stop needed." }
        ]}
      ]
    },
    {
