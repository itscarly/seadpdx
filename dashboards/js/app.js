...
const STOP_COORDINATES = {
  ...
  "Target Downtown Seattle - Truly Hard Seltzer run": { lat: 47.6113, lng: -122.3374, label: "Target Downtown Seattle" },
  "H Mart International District - grocery run": { lat: 47.5977, lng: -122.3253, label: "H Mart" },
