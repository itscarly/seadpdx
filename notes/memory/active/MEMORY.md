...
- [Project current state](project_current_state.md) — Seattle: Boylston $504.46 (conf 7225329631916). Portland: Hotel Vance $412.96 (conf 94290711) is the active base -- Courtyard was stale, do not reintroduce. Confirmed hotels $917.42, projected local spend $1,069 as of the 2026-08-02 price audit.
