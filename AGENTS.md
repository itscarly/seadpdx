...
- After editing itinerary data or dashboard JavaScript, run `npm run validate`. It syntax-checks `data/trip-data.js` and `dashboards/js/app.js`, then runs the budget audit and rebuilds the calendar export artifacts. It is the fastest full regression check in this repo.
